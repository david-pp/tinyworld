...
template <typename ConnType, typename PoolType>
class ScopedConnectionByShard: public boost::noncopyable
{
public:
...
template <typename ConnType, typename PoolType>
class ScopedConnectionByHash: public boost::noncopyable
{
public:
...
template <typename ConnType, typename PoolType>
class ScopedConnectionByKey: public boost::noncopyable
{
public:
