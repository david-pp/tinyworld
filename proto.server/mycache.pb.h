...
#ifndef PROTOBUF_mycache_2eproto__INCLUDED
#define PROTOBUF_mycache_2eproto__INCLUDED
...
class Set : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Cmd.Set)
 private:
  ...
  friend void  protobuf_AddDesc_mycache_2eproto();
  friend void protobuf_AssignDesc_mycache_2eproto();
  friend void protobuf_ShutdownFile_mycache_2eproto();
...
inline void Set::set_key(const void* value, size_t size) {
  set_has_key();
  if (key_ == &::google::protobuf::internal::kEmptyString) {
    key_ = new ::std::string;
  }
...
#endif  // PROTOBUF_mycache_2eproto__INCLUDED
