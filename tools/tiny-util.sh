...
copy_orm()
{
    ...
    copy example/tinyobj/tinyobj.cpp     $OUTPUTDIR/example/tinyobj/tinyobj.h
    copy example/tinyobj/tinyplayer.xml  $OUTPUTDIR/example/tinyobj/tinyobj.cpp
    copy example/tinyobj/CMakeLists.txt  $OUTPUTDIR/example/tinyobj/tinyplayer.xml
